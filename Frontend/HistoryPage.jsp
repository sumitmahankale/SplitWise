    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>Celebrations</td>
          <td>2024-01-01</td>
          <td>New Year Celebration: A global event marking the start of the new year.</td>
          <td><button class="view-button">View</button></td>
        </tr>
        <tr>
          <td>National Events</td>
          <td>2024-07-04</td>
          <td>Independence Day: Celebration of independence with fireworks and parades.</td>
          <td><button class="view-button">View</button></td>
        </tr>
        <tr>
          <td>Festivals</td>
          <td>2024-12-25</td>
          <td>Christmas Day: Holiday celebrating Christmas traditions around the world.</td>
          <td><button class="view-button">View</button></td>
        </tr>
      </tbody>
    </table>
